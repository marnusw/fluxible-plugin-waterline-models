  ...
  return {
    ...
    plugContext: function() {
      return {
        ...
        /**
         * Provides the `models` dictionary on the store context. This can be used to validate model
         * data and do async requests for models from the server. Only queries are allowed in stores,
         * all updates should be done via actions.
         *
         * @param {Object} storeContext
         */
        plugStoreContext: function(storeContext) {
          storeContext.models = waterlineCollections;
        }
      };
    },
    ...
    buildOrm: function(cb, adapters) {
      var self = this;
      buildOrm(adapters || serverAdapters, options, function(err, ormModels) {
        if (err) {
          return cb(err);
        }
     ...
     * TODO: Implement similar to the Sails.js implementation.
     */
    tearDownOrm: function() {
